...
<!-- left -->
			<div id="left_column" class="column_wrapper">
				...
				<div id="sleep_last" class="content_box">
					<img src="http://dl.dropbox.com/u/1700083/sleepgraph/sleepgraph_<?php echo date('ymd'); ?>.jpg" alt="Nick's Sleepgraph for <?php echo date('l jS \of F Y'); ?>" />
					<p>I slept for <iframe src="https://spreadsheets8.google.com/pub?hl=en&hl=en&key=0Atv7Kh0l7ItmdEZkcmg5M2l5WjE0VVU0RHFDNXZrS1E&single=true&gid=4&range=G<?php $cell = date('z') + 231; echo $cell; ?>&output=html" scrolling="no" frameborder="0" style="border: medium none; overflow:hidden; display: inline; height: 20px; width: 70px;"></iframe> hours last night.</p>
				</div>
				<div id="sleep_graph" class="content_box">
								<script type="text/javascript" src="//ajax.googleapis.com/ajax/static/modules/gviz/1.0/chart.js"> {"dataSourceUrl":"//spreadsheets4.google.com/spreadsheet/tq?key=0Atv7Kh0l7ItmdEZkcmg5M2l5WjE0VVU0RHFDNXZrS1E&transpose=0&headers=1&merge=COLS&range=A100%3AA300%2CG100%3AG300%2CK100%3AK300%2CL100%3AL300&gid=4&pub=1","options":{"vAxes":[{"min":null,"title":null,"max":null}],"series":[{"type":"bars"}],"title":"Sleep","backgroundColor":"#ffffff","legend":"right","colors":["#3366CC","#DC3912","#FF9900","#109618","#990099","#0099C6","#DD4477","#66AA00","#B82E2E","#316395"],"type":"line","logScale":false,"hAxis":{"maxAlternation":1},"hasLabelsColumn":true,"vAxis":{"format":"#,##0.00"},"width":318,"height":276},"state":{},"chartType":"ComboChart","chartName":"Chart 5"} </script>
				</div>
			</div>
<!-- left -->
<!-- center -->
